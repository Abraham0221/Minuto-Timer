...
function PTimer(){
    ...
    return (
         <>
         <div className='timer-wrapperp'>
            <div className="overlay-p" ref={overlayRef}></div>
            <div className="timerContainer-p" ref={containerRef}>
                <label className='label-p' htmlFor="timerInput">Set Timer </label>
                <input type="text" id='timerInput' ref={inputRef} placeholder="EX: 01:30:00" className='input-p' />
                <button className="btn-p" onClick={handleClick}>Enter</button>
            </div>
